...
description: Modern vehicles are rapidly evolving into AI-defined, software-centric systems, where user experience, safety, and functionality are increasingly shaped by real-time data processing and on-device intelligence rather than fixed-function hardware. This project involves prototyping an AI-defined IVI system on the Arm-powered Radxa Orion O6.
subjects:
- ML
